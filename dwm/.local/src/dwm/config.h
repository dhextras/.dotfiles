...
static const char *fonts[]          = { "ComicShannsMono Nerd Font:size=12", "ComicShannsMono Nerd Font:size=14" };
...
static const char *colors[][3] = {
    ...
    [SchemeSel]  = { col_bg,    col_accent_blue, col_accent_blue },
};

/* tagging */
static const char *tags[] = {"%{T1} %{T-}", "󰖟 ", "󰍦 ", " ", " ", "󰙯 ", "󰊠 ", "󰑓 "};
